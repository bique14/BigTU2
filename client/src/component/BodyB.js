...
import { Tab, Label, Form, Dropdown, Divider, Grid, Button, Icon, TextArea, Checkbox, Modal } from 'semantic-ui-react'
...
export class BodyB extends React.Component {
    ...
    validateLaborTel = (e) => {
        ...
        e.target.value.match(regexTel) ?
            ...
            }, () => { console.log('[validate] labor telephone no', this.state.chkLaborTel, this.state.laborTel) }) :
            this.setState({
                chkLaborTel: false,
            })
    }
    ...
    validateLaborID = (e) => {
        ...
        e.target.value.match(regexLaborID) ?
            ...
            }, () => { console.log('[validate] labor id', this.state.chkLaborID, this.state.laborID) }) :
            this.setState({
                chkLaborID: false
            })
    }
...

                        {
                            this.state.isFollower ? null :
                                <div>
                                    ...
                                    <div><Checkbox label={<label>สามี</label>} onClick={() => { this.setState({ haveHusband: !this.state.haveHusband }) }} /></div>
                                    <div><Checkbox label={<label>ภรรยา</label>} onClick={() => { this.setState({ haveWife: !this.state.haveWife }) }} /></div><br />
                                    <div><Checkbox label={<label>บุตร/หลาน/ญาติ(อายุมากกว่า 15 ปี)</label>} onChange={this.chkFollowerMore15} /></div>
                                    {
                                    ...
                                    <div><Checkbox label={<label>บุตร/หลาน/ญาติ(อายุน้อยกว่า 15 ปี)</label>} onChange={this.chkFollowerLess15} /></div>
                                    {
                                    ...
                                    <div><Checkbox label={<label>อื่นๆ</label>} onChange={this.chkFollowerOther} /></div>
                                    {
