...
export default class BodyC extends React.Component {
  constructor(props) {
    super(props);
  ...
  onSubmitForm = () => {
    this.props.getStateFormC(this.state);
  };
  ...
  render() {
    // var countChild = new Array(this.props.countData);
    return (
      <div>
        <Tab.Pane attached={false}>
          ...
          <div>
            <Divider horizontal>ข้อมูลบุตร/หลาน/ญาติ คนที่ 1</Divider>
            <Form>
              ...
              <div>
                <Checkbox
                  label={<label>ระดับอนุบาล</label>}
                  onChange={this.chkIsNursery}
                />
              </div>
              ...
              <div>
                <Checkbox
                  label={<label>ระดับประถมศึกษา</label>}
                  onChange={this.chkIsPrimary}
                />
              </div>
              ...
              <div>
                <Checkbox
                  label={<label>ระดับมัธยมศึกษาตอนต้น</label>}
                  onChange={this.chkIsSecondary}
                />
              </div>
              ...
              <div>
                <Checkbox
                  label={<label>ระดับมัธยมศึกษาตอนปลาย</label>}
                  onChange={this.chkIsHighSchool}
                />
              </div>
            ...
            <Divider horizontal>ข้อมูลบุตร/หลาน/ญาติ คนที่ 2</Divider>
            <Form>
              <Form.Group widths="equal">
                <Form.Input
                  fluid
