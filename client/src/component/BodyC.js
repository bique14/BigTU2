            ...
            return (
              <div>
                ...
                <Form>
                  ...
                  <div>
                    <Checkbox label={<label>ระดับอนุบาล</label>} />
                  </div>
                  <Form.Input
                    fluid
                    id="form-subcomponent-shorthand-input-first-name"
                  ...
                  />
                  <div>
                    <Checkbox label={<label>ระดับประถมศึกษา</label>} />
                  </div>
                  <Form.Input
                    fluid
                    id="form-subcomponent-shorthand-input-first-name"
                  ...
                  />
                  <div>
                    <Checkbox label={<label>ระดับมัธยมศึกษาตอนต้น</label>} />
                  </div>
                  <Form.Input
                    fluid
                    id="form-subcomponent-shorthand-input-first-name"
                  ...
                  />
                  <div>
                    <Checkbox label={<label>ระดับมัธยมศึกษาตอนปลาย</label>} />
                  </div>
                  <Form.Input
                    fluid
                    id="form-subcomponent-shorthand-input-first-name"
                  ...
                  />
                  <div>
                    <Checkbox label={<label>อื่นๆ</label>} />
                  </div>
                  <Form.Input
                    fluid
                    id="form-subcomponent-shorthand-input-first-name"
